(() => {
    ...
    function initSliders() {
        if (document.querySelector("#swiper-offer")) new core("#swiper-offer", {
        ...
        if (document.querySelector("#swiper-rooms")) new core("#swiper-rooms", {
            modules: [ Pagination, Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    function isOpen(element) {
        if (!element.classList.contains(CLASSES.open)) return false;
        return true;
    }
    ...
    function closeModal(modal) {
        ...
        if (!isOpen(DOM.header)) DOM.body.classList.remove(CLASSES.scrollHidden);
    }
